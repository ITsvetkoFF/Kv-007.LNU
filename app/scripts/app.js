...
angular
  ...
  //   $httpProvider.interceptors.push(['$q', '$localStorage', 'AuthorizationSvc',
  //     function ($q, $localStorage, AuthorizationSvc) {
  //       return {
  //         'request': function (config) {
  //           console.log('config', config);
  //           config.headers = config.headers || {};
  //           if (AuthorizationSvc.isAuthorized) {
  //             config.headers.Authorization = 'Basic ' + AuthorizationSvc.token;
  //           }
