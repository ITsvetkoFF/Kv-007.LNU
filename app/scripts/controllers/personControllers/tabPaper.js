...
angular.module('admissionSystemApp')
  .controller('tabPersonPapers', ['$scope', '$http', '$modal', '$rootScope', 'SpecofferDictionaryService', function ($scope, $http, $modal, $rootScope, SpecofferDictionaryService) {
    ...
    SpecofferDictionaryService.getPublicActivities().then(function (publicActiv) {
    ...
    $scope.setAdditionalData = function (id) {
      SpecofferDictionaryService.getPublicActivitiesAwards(id).then(function (awards){
